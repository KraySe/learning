...
class SimpleCommand implements Command {
    public constructor(private readonly payload: string) { }
...
class ComplexCommand implements Command {
    ...
    /**
     * Cointext data, required for launching the receiver`s methods.
     * 
 ...
 * In fact, any class may serve as Receiver.
 */
class Receiver {
...
class Invoker {
    ...
    public constructor(private readonly onStart: Command, private readonly onFinish: Command) {
